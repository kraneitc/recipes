...
description: Oven-baked spiced meatballs with chunky tomato and onion sauce, served over spaghetti.
status: draft
servings: 6
prep_minutes: 25
cook_minutes: 40
...
- 500 g beef mince, or a beef-and-pork mixture
...
- Salt, as directed on the packet (optional)
...
1. Preheat the oven to 180°C fan-forced. Combine all the prepared meatball mixture ingredients in the large bowl, mixing just until evenly incorporated.
...
- Chilli strength varies. This version uses all the chilli and cayenne specified in the source notes and is intended to be hot.
- If using a beef-and-pork mixture, make sure the centre of the largest meatball is fully cooked before serving.
